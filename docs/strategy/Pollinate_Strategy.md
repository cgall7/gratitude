...
| Private Hives | 1 hive | Unlimited |
...
| Freemium conversion too low | Medium | High | Ensure free tier is useful but upgrade triggers are natural (second hive, monthly reviews — send limit pending Colin's ruling, see business model note). Test paywall placement and messaging. The emotional payoff of receiving a package should drive recipients to start their own hive and eventually upgrade. |
